...
<body>
    <div class="container">
        ...
        <h2 class="text-center">Laporan Kunjungan Tanggal <?= $dari_tanggal . ' ' . BULAN_DALAM_INDONESIA[$dari_bulan - 1] . ' ' . $dari_tahun; ?> - <?= $sampai_tanggal . ' ' . BULAN_DALAM_INDONESIA[$sampai_bulan - 1] . ' ' . $sampai_tahun; ?></h2>
        <table>
            <thead>
                <tr>
