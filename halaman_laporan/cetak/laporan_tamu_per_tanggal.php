    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <?php
                $no = 1;
                $result = $mysqli->query("SELECT * FROM tabel_tamu WHERE tanggal='$tahun_bulan_tanggal' AND id_divisi LIKE '%$id_divisi%' AND id_pegawai LIKE '%$id_pegawai%' ORDER BY id DESC");
                ?>
