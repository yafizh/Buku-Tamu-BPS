...
<head>
    ...
    <title>Laporan Pengajuan Kunjungan</title>
    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <?php
                $no = 1;
                $result = $mysqli->query("SELECT * FROM view_pengajuan WHERE tanggal BETWEEN '$dari_tahun_bulan_tanggal' AND '$sampai_tahun_bulan_tanggal' ORDER BY id DESC");
                ?>
