...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title text-dark"> Detail User Tamu </h3>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card bg-light">
                        <div class="card-body">
                            <h4 class="card-title text-dark">Indentitas User Tamu</h4>
                    ...
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-dark bg-light" name="username" autocomplete="off" placeholder="Masukkan username..." value="<?= $row['username']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label class="text-dark" for="password">Password</label>
                                <input type="text" class="form-control text-dark bg-light" name="password" autocomplete="off" placeholder="Masukkan password..." value="<?= $row['password']; ?>" required>
                            </div>
                            <div class="form-group">
