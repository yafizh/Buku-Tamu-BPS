    ...
    <div class="wrapper">
        ...
        <form method="POST" class="p-3 mt-3" style="margin-top: 10px;">
            <div class="form-field d-flex align-items-center">
                ...
                <input autocomplete="off" autofocus type="text" name="username" id="username" placeholder="Username">
            </div>
            <div class="form-field d-flex align-items-center">
        ...
        <div class="text-center fs-6" style="text-align: center; margin-top: 8px;"> <a href="halaman_register.php">Daftar Baru</a></div>
    </div>
